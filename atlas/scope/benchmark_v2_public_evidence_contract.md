...
| `run_grid_manifest` | `benchmark_v2/run_grid_manifest.parquet` | `method_row_key`, `paired_cell_key`, `alpha`, `seed`, `split_hash`, `learner_config_id`, `conformal_method_config_id`, `planned_status` |
