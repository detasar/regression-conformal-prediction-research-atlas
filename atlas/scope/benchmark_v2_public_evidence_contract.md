...
| `run_grid_manifest` | `benchmark_v2/run_grid_manifest.parquet` | `paired_cell_key`, `alpha`, `seed`, `split_hash`, `learner_config_id`, `conformal_method_config_id`, `planned_status` |
| `run_status_ledger` | `benchmark_v2/run_status_ledger.parquet` | `paired_cell_key`, `attempted`, `completed`, `failed`, `skipped`, `failure_reason`, `checkpoint_path_hash` |
