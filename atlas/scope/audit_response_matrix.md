...
| P1 | Define the balanced, paired, leakage-safe Benchmark v2 before new result generation. | `execution_contract_defined_not_executed` | `atlas/scope/benchmark_v2_protocol.md`<br>`atlas/scope/benchmark_v2_protocol.json`<br>`atlas/scope/benchmark_v2_execution_manifest.md`<br>`atlas/scope/benchmark_v2_execution_manifest.json`<br>`atlas/scope/benchmark_v2_public_evidence_contract.md`<br>`atlas/scope/benchmark_v2_public_evidence_contract.json` |
