...
| P0 | Expose provenance as manifest resolution rather than pretending restricted source files are public. | `completed` | `atlas/provenance/artifact_manifest.json`<br>`evidence/public_artifact_manifest.json`<br>`site/kg_browser_data.json` |
...
| P1 | Define the balanced, paired, leakage-safe Benchmark v2 before new result generation. | `candidate_registries_published_execution_not_started` | `atlas/scope/benchmark_v2_protocol.md`<br>`atlas/scope/benchmark_v2_protocol.json`<br>`atlas/scope/benchmark_v2_execution_manifest.md`<br>`atlas/scope/benchmark_v2_execution_manifest.json`<br>`atlas/scope/benchmark_v2_public_evidence_contract.md`<br>`atlas/scope/benchmark_v2_public_evidence_contract.json`<br>`atlas/benchmark_v2/preflight/README.md`<br>`atlas/benchmark_v2/preflight/run_grid_cardinality.json`<br>`atlas/benchmark_v2/preflight/preflight_readiness_checklist.json`<br>`atlas/benchmark_v2/candidates/source_dataset_registry_candidate.csv`<br>`atlas/benchmark_v2/candidates/task_variant_registry_candidate.csv`<br>`atlas/benchmark_v2/candidates/candidate_selection_rationale.json` |
| P1 | Build the interactive result-atlas layer. | `partially_completed` | `atlas/results/index.html`<br>`atlas/datasets/index.html`<br>`atlas/datasets/cards/*.html`<br>`atlas/methods/index.html`<br>`atlas/methods/cards/*.html`<br>`atlas/ui_data/dataset_method_heatmap.json`<br>`atlas/ui_data/method_family_summary.json` |
...
| P2 | Modularize monolithic builders and add broader maintenance gates. | `schema_migration_seeded_modularization_pending` | `atlas/maintenance/maintenance_gate_matrix.md`<br>`atlas/maintenance/maintenance_gate_matrix.json`<br>`atlas/maintenance/schema_registry.json`<br>`atlas/maintenance/schema_migration_fixtures.json`<br>`reproducibility/experiments/regression/scripts/` |
