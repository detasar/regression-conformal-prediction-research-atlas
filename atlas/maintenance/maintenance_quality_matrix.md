...
- check_count: `9`
- implemented_check_count: `7`
- partial_check_count: `2`
- planned_check_count: `0`
- ci_enforced_check_count: `9`
...
| Accessibility and academic metadata check | `implemented` | `True` | main public pages and atlas pages | Add automated axe/lighthouse-style checks and tagged-PDF validation. |
