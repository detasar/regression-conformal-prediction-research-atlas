...
S1c & Check the completed balanced Benchmark v2 result surface. & Benchmark v2 terminal rows=42,000; completed rows=29,683; selected cells are cqr\_\allowbreak{}model\_\allowbreak{}matched=4,415, cv\_\allowbreak{}plus=1,216, mondrian\_\allowbreak{}abs=1,265, split\_\allowbreak{}abs=281, jackknife\_\allowbreak{}plus=173. & Use as balanced follow-up evidence under the frozen Benchmark v2 utility rule. & Do not turn Benchmark v2 selections into a universal method-choice or deployment rule. \\
...
\subsection{S1c. Benchmark v2 Completion Check}
...
Live integrity status & \texttt{pass} & Critical violations=0 \\
\bottomrule
\end{tabular}
\endgroup
...
\item Benchmark v2 is a completed balanced follow-up benchmark; its selections remain descriptive.
