...
S6 & Check how the evidence map supports source inspection. & 3,643 KG nodes, 21,019 edges, 0 isolated nodes, with study scope tracked separately. & Use the KG and package for claim tracing and source navigation. & Keep KG/site citation scope tied to the Research Atlas release package. \\
\bottomrule
\end{tabular}
\endgroup
