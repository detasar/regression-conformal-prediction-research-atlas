...
S6 & Check whether traceability artifacts are review infrastructure or public outputs. & 3,643 KG nodes, 21,019 edges, 0 isolated nodes, and evidence scope recorded in the manifest. & Use the KG and package for evidence tracing. & Use the KG and site to inspect how claims connect to evidence. \\
\bottomrule
\end{longtable}
\endgroup
