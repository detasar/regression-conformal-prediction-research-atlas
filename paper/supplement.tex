...
\midrule
S1 & Check whether the method-selection signal is robust enough to describe, but not promote. & CQR common-cell wins 58 of 94 cells; bootstrap selection count is cqr=1,000. & Report the fixed-GBM CQR, Mondrian, and CV+ pattern as experiment-scoped evidence. & Keep CQR within experiment-scoped interpretation rather than a study-wide method choice or universal deployment rule. \\
...
S6 & Check how the evidence map supports source inspection. & 3,643 KG nodes, 21,019 edges, 0 isolated nodes, with evidence scope tracked separately. & Use the KG and package for claim tracing and source navigation. & Keep KG/site citation scope tied to the Research Atlas release package. \\
\bottomrule
\end{tabular}
\endgroup
...
Common-cell selected diagnostic method & \texttt{cqr} & Descriptive comparison label \\
...
Reader note: this section explains why CQR/CV+ can be reported as experiment-scoped practical signals observed in these experiments while the final-selection gate remains beyond this study. The descriptive ranges summarize uncertainty around the observed rates; they do not change the validation state of the final-selection claim.
...
Study-wide method selection supported & \texttt{False} & Backend sensitivity evidence only \\
\bottomrule
\end{tabular}
\endgroup
