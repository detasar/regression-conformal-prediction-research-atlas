...
Bootstrap counts & cqr=1,000 & Selection-stability diagnostic only \\
...
Study-wide method selection supported & \texttt{False} & No study-wide method selection follows from this table \\
\bottomrule
\end{tabular}
\endgroup
...
\item Method evidence is diagnostic; no study-wide method choice or deployment rule is established.
