...
| Practical candidate pattern | CQR/CV+ were observed as strong practical candidates in these experiments, with CQR carrying the largest descriptive frontier count (56) and CV+ contributing 13 frontier cells. | Main article claim-evidence map, result reading guide, and supplementary robustness diagnostics. | This is evidence for neither final method selection nor global superiority. |
