...
| `supplementary_document` | `methodology_record_claim` | The study includes audit controls for traceability, neutrality, and reproducibility. | Control descriptions support reproducibility claims; scientific validity rests on the empirical evidence. | Controls support reproducibility; scientific validity still rests on the empirical evidence. | This row explains the guardrails around the study rather than claiming the guardrails make every result final. |
