...
The table below pairs each reader-facing claim with source-backed evidence and interpretation scope. This keeps useful empirical signals separate from unsupported deployment rules, group-inference claims, endpoint-validity claims, and unsupported scope-expansion claims.
...
\begin{itemize}
\item \texttt{individual\_\allowbreak{}experiment\_\allowbreak{}report\_\allowbreak{}source}: \texttt{experiments/\allowbreak{}regression/\allowbreak{}Research Document/\allowbreak{}individual\_\allowbreak{}experiment\_\allowbreak{}report\_\allowbreak{}source.\allowbreak{}json}
