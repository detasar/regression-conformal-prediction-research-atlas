...
\item It keeps population-level group inference, bounded-support validity, final method selection, Research Atlas, and citable web-artifact claims beyond this study unless their explicit evidence gates are opened later.
\end{itemize}
...
Citation and traceability & When can artifacts be cited or published? & Reader review package and KG navigation artifacts. & The artifacts support reader review and traceability. & The Research Atlas includes the KG and site as navigation and traceability artifacts. \\
\bottomrule
\end{longtable}
\endgroup
