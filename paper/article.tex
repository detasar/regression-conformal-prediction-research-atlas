...
Research Atlas site and KG browser & Use the site and KG browser to trace claims to source artifacts, citation gates, quality checks, nodes, edges, and provenance. & KG citation, GitHub Pages, and Research Atlas site publication require separate validation. & Use the site as a Research Atlas review portal with explicit lanes. \\
...
Which stronger stronger claims require separate validation? & Bounded-support validity and population-level group inference require separate validation: 0 bounded-support-validity-ready bundles and 0 population-group-inference-ready bundles. & Paper gate map, bounded-support audit, group-diagnostic audit, and claim matrix. & Keep diagnostic endpoint and group evidence separate from validity or group-inference conclusions. \\
