"""Audit NHANES 2017-2018 glycohemoglobin regression source."""
...
TARGET = "LBXGH"
RAW_FILES = ["DEMO_J.XPT", "GHB_J.XPT"]
...
GHB_DOC = "https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/2017/DataFiles/GHB_J.htm"
DEMO_XPT = "https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/2017/DataFiles/DEMO_J.XPT"
GHB_XPT = "https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/2017/DataFiles/GHB_J.XPT"
...
def load_joined_frame(raw_dir: Path) -> pd.DataFrame:
    ...
    ghb[TARGET] = pd.to_numeric(ghb[TARGET], errors="coerce")
    return demo.merge(ghb, on="SEQN", how="inner")
...
def build_model_frame(
    ...
    *,
    ...
    """Return the audited NHANES glycohemoglobin model frame."""
...
def build_profile(
    ...
    audit.update(
        {
            ...
            "target_policy": (
                "Use CDC NHANES glycohemoglobin percentage LBXGH as the "
                "laboratory regression target. Drop rows with missing LBXGH for "
                "audit profiling. Runner use requires lab-item nonresponse and "
                "12+ eligible-sample policy."
            ),
            "lab_policy": (
                "Glycohemoglobin is measured from whole blood specimens and "
                "reported in percent. The audit model frame excludes no target "
                "components because GHB_J exposes only SEQN and LBXGH."
            ),
            "survey_policy": (
    ...
    return {
        ...
        "target": TARGET,
        "source": {
            "name": "NHANES 2017-2018 Glycohemoglobin HbA1c",
            "demo_doc": DEMO_DOC,
            "ghb_doc": GHB_DOC,
            "demo_xpt": DEMO_XPT,
            "ghb_xpt": GHB_XPT,
